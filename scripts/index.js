...
export function loadProducts(productData,div) {
  let productHTML = '';
  ...
  productData.forEach((product, index) => {
    ...
    <div class="rounded-lg border border-gray-200 bg-white p-6 shadow-sm dark:border-gray-700 dark:bg-gray-800">
      <div class="h-56 w-full">
        <a href="#">
          <img class="mx-auto h-full dark:hidden" src=${product.image.light} alt="" />
      ...
      <div class="pt-6">
        <div class="mb-4 flex items-center justify-between gap-4">
          <span class="me-2 rounded bg-primary-100 px-2.5 py-0.5 text-xs font-medium text-[#1e40af] dark:bg-primary-900 dark:text-primary-300"> Up to ${product.discount}% off </span>
        ...
        <div class="mt-2 flex items-center gap-2">
          ...
          <p class="text-sm font-medium text-gray-900 dark:text-white">${product.details.rating}</p>
          <p class="text-sm font-medium text-gray-500 dark:text-gray-400">(${product.details.reviews})</p>
        </div>
        ...
        <div class="mt-4 flex items-center justify-between gap-4">
          <p class="text-2xl font-extrabold leading-tight text-gray-900 dark:text-white">$${product.details.price}</p>
